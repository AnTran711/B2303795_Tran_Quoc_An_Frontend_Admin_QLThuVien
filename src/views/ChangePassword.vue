<script setup>
  ...
  const employeeChangePassword = reactive({
    DIENTHOAI: null,
    MATKHAU: null,
    MATKHAUMOI: null
  });
  ...
  const changePassword = async () => {
    ...
    await employeeStore.changePassword(employeeChangePassword);
              ...
              >
                ...
                <v-card-text class="pt-4">
                  ...
                  <v-form ref="formRef" @keyup.enter="changePassword">
                    ...
                    <v-text-field
                      v-model="employeeChangePassword.DIENTHOAI"
                      label="Số điện thoại"
                      variant="outlined"
                    ...
                    <!-- Mật khẩu cũ -->
                    <v-text-field
                      v-model="employeeChangePassword.MATKHAU"
                      ref="oldPwdField"
                      class="mt-2"
                      label="Mật khẩu cũ"
                      variant="outlined"
                    ...
                    <!-- Mật khẩu mới -->
                    <v-text-field
                      v-model="employeeChangePassword.MATKHAUMOI"
                      ref="newPwdField"
                      class="mt-2"
                      label="Mật khẩu mới"
                      variant="outlined"
                    ...
                    <v-text-field
                      ...
                      clearable
                      :rules="[rules.required, rules.confirm(employeeChangePassword.MATKHAUMOI)]"
                    />
                  </v-form>
                </v-card-text>
