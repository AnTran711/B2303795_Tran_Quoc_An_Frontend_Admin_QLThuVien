<script setup>
  ...
  const register = async () => {
    ...
    await employeeStore.register(employee);
...
<template>
  <v-app>
    <div class="app">
      <v-card width="800" class="rounded-xl zoom-in">
        <!-- Phần title đăng ký -->
            ...
            <v-container>
              <v-row  class="register-container">
                <v-col cols="6">
                  ...
                  <!-- Giới tính -->
                  <v-radio-group v-model="employee.PHAI" inline :rules="[rules.required]">
                ...
                <v-col cols="6">
                  ...
                  <v-text-field
                    ...
                    clearable
                    :rules="[rules.required, rules.confirm(employee.MATKHAU)]"
                  />
                </v-col>
              </v-row>
            </v-container>
